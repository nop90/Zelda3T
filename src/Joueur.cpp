...
void Joueur::save() {
    ...
    ostringstream im;
    im << numSave;
    ofstream f(("/3ds/Zelda3t/3t" + im.str() + ".dat").c_str(),ios::out | ios::binary);
...
void Joueur::load() {
    ...
    ostringstream im;
    im << numSave;
    ifstream f(("/3ds/Zelda3t/3t" + im.str() + ".dat").c_str(),ios::in | ios::binary);
    if(!f.is_open()) return;
...
void Joueur::setBouclier(int b) {
    ...
    im << bouclier;
    if (oni) boucl = new Bouclier(IMG_Load("romfs:/images/link/bouclierOni.png"), 10);
...
void Joueur::setEpee(int e) {
    ...
    std::ostringstream im;
    im << epee;
    if (oni) imageEpee = IMG_Load("romfs:/images/link/epeeOni.png");
