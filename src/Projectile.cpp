...
void Projectile::changeType(int type) {
    ...
    switch (type) {
        ...
        case 33 : //flèche d'or
            switch (id) {
                case 1 : image = IMG_Load("romfs:/images/objet/projectiles.png"); break;
                case 2 : image = IMG_Load("romfs:/images/objet/projectilesarg.png"); break;
                case 30 : image = IMG_Load("romfs:/images/objet/projectilesfeu.png"); break;
                case 31 : image = IMG_Load("romfs:/images/objet/projectilesglace.png"); break;
                case 32 : image = IMG_Load("romfs:/images/objet/projectileslum.png"); break;
                case 33 : image = IMG_Load("romfs:/images/objet/projectilesor.png"); break;
            }
            w=16; h=16;
        ...
        case 40 : //Zzzz
            image = IMG_Load("romfs:/images/objet/Zzzz.png");
            w=8; h=16;
            zx=0; zy=0; zw=w; zh=h;
            max=3; vanim=240;
            break;
        case 41 : //naufrage
            image = IMG_Load("romfs:/images/objet/naufrage.png");
            w=32; h=32;
            zx=0; zy=0; zw=w; zh=h;
            max=3; vanim=60;
            break;
        case 42 : //Wagonnet
            image = IMG_Load("romfs:/images/objet/Wagon.png");
            w=2; h=26;
            zx=0; zy=0; zw=w; zh=h;
            max=0; break;
    }
